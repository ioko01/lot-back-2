...
export const create_initial_database = (res: Response) => {
    connections.getConnection((err: NodeJS.ErrnoException | null, conn: PoolConnection) => {
        ...
        CREATE TABLE IF NOT EXISTS lottos(
            ...
            l_groups VARCHAR(255) NULL COMMENT "กลุ่มหวย",
        ...
        CREATE TABLE IF NOT EXISTS bills(
            ...
            b_status ENUM("WAIT", "CANCEL", "REWARD") NULL DEFAULT "WAIT" COMMENT "สถานะ",
        ...
        CREATE TABLE IF NOT EXISTS promotions(
            ...
            p_name VARCHAR(255) NOT NULL COMMENT "ชื่อโปรโมชั่น",
            store_id VARCHAR(255) NOT NULL COMMENT "ไอดีร้านค้า",
            rate_template_id VARCHAR(255) NOT NULL COMMENT "ไอดีเทมเพลตเรทราคา",
            date_promotion JSON DEFAULT "{}" COMMENT "วันที่จัดโปรโมชั่น",
            p_status ENUM("USED", "NOT_USED") DEFAULT "NOT_USED" COMMENT "สถานะการใช้งาน",
            user_create_id VARCHAR(255) COMMENT "ไอดีผู้สร้าง",
            created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
            updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
